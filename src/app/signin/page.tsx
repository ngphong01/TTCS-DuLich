        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-12 text-center">
            ...
            <p className="text-blue-100 text-sm">
              Đăng nhập để tiếp tục với TravelGo
            </p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                className="w-full flex justify-center items-center px-4 py-3 border border-gray-200 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 group"
              >
